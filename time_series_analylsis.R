...
movie %>%
  ...
  scale_fill_gradient(name = "Average Revenue",low = "lightskyblue1", high = "deepskyblue3") +
  labs(x = "Month", y = "genre", title = "heat graph for average revenue between month and genre")
