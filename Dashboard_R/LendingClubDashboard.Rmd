...
dataset <- data %>%
    mutate(term = as.factor(term),
           ...
           emp_length=as.numeric(unlist(stri_extract_all_regex(emp_length,"[0-9]+"))),
           term=as.numeric(unlist(stri_extract_all_regex(term,"[0-9]+"))),
...
create dashboard using shiny dashboard
...
track_bar_app <- plot_data %>%
    ...
    labs(x =  "", y = "", title = "Monthly Charged Off Vs. Fully Paid Ratio") +
